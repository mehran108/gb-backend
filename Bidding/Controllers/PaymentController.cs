...
namespace GoldBank.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        [HttpPost("GetOnlinePaymentSummary")]
        public async Task<OnlinePaymentSummary> GetOnlinePaymentSummary()
        {
            return await this.PaymentApplication.GetOnlinePaymentSummary();
        }
        ...
        [HttpPost("GetAllCashManagementSummary")]
        public async Task<List<StoreCashManagementSummary>> GetAllCashManagementSummary([FromBody] StoreCashManagementRequestVm request)
        {
