    ...
    public class ProductInfrastructure : BaseInfrastructure, IProductInfrastructure
    {
        ...
        public async Task<int> Add(Product entity)
        {
            ...
            var parameters = new List<DbParameter>
            {
                ...
                base.GetParameter(ProductInfrastructure.CategoryIdsParameterName, entity.Jewellery.CategoryIds),
                base.GetParameter(ProductInfrastructure.SubCategoryIdsParameterName, entity.Jewellery.SubCategoryIds),
